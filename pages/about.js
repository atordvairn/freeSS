    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <Box boxShadow='xl' p='10' rounded='md'>
           <a href="https://www.producthunt.com/posts/freess?utm_source=badge-review&utm_medium=badge&utm_souce=badge-freess#discussion-body" target="_blank" rel="noreferrer"><img src="https://api.producthunt.com/widgets/embed-image/v1/review.svg?post_id=327801&theme=light" alt="freeSS - a free and powerfull screenshot tool for the web. | Product Hunt" style={{width: "250px", height: "54px" }} /></a>
           <a href="https://www.producthunt.com/posts/freess?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-freess" target="_blank" rel="noreferrer"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=327801&theme=light" alt="freeSS - a free and powerfull screenshot tool for the web. | Product Hunt" style={{width: "250px", height: "54px" }} /></a>
        </Box>
      </main>
