...
export default function Home() {
  ...
  useEffect(() => {
        const script = document.createElement('script')
          ...
          script.setAttribute('data-repo', "atordvairn/freeSS")
          script.setAttribute('data-repo-id', "R_kgDOGq2aSQ")
          script.setAttribute('data-category', "General")
          script.setAttribute('data-category-id', "DIC_kwDOGq2aSc4CAquD")
          ...
          return () => {
            const comments = document.getElementById("giscus")
